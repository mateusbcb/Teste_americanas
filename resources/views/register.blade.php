...
<head>
  ...
  <title>B2W - Registration Page</title>
...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="{{ route('accounts.create') }}" method="get" enctype="multipart/form-data">
        @csrf
      ...
      <a href="{{ route('accounts.index') }}" class="text-center">Eu já tenho um usuário</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
